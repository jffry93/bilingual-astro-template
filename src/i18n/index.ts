...
export const ui = {
  fr: {
    ...
    'services.subtitle': 'Une expertise complète pour tous vos projets de construction',
    ...
    'meta.home.title': `${siteConfig.company.name.fr} - Entrepreneur en construction résidentielle`,
    'meta.home.description': `Entreprise familiale québécoise spécialisée en construction résidentielle. Plus de ${siteConfig.company.experience} ans d'expérience. Devis gratuit disponible.`,
  ...
  en: {
    ...
    'services.subtitle': 'Complete expertise for all your construction projects',
    ...
    'meta.home.title': `${siteConfig.company.name.en} - Residential Construction Contractor`,
    'meta.home.description': `Quebec family business specializing in residential construction. Over ${siteConfig.company.experience} years of experience. Free quotes available.`,
